class Map {
    ...
    async fetchCoordinates(location) {
        ...
        let url = `https://www.mapquestap.com/geocoding/v1/address?key=${this.apiKey}&location=${location}`;
    ...
    async fetchOptions(query) {
        let url = `https://www.mapquestap.com/search/v3/prediction?key=${this.apiKey}&limit=7&collection=adminArea&countryCode=us,ca,mx&q=${query}`;
